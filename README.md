<div align="center">
<h1 style="font-size: 40px; font-weight: bold; font-family: 'New York', serif; padding: 20px;">One Big, Beautiful Browser</h1>
</div>
...
This is a Chrome extension that allows you to use AI to help you with your work.
